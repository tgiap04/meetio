...
import { AUDIO_SOURCE_OPTIONS, RECORDING_SETTINGS_DEFAULTS } from '../../src/mocks/recording-options.mock';
...
export default function RecordingSetupScreen() {
  ...
  const [translationEnabled, setTranslationEnabled] = useState(RECORDING_SETTINGS_DEFAULTS.translationEnabled);
    ...
    <View style={styles.screen}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.section}>
          ...
          <AudioSourceCard onSelect={setSourceId} options={AUDIO_SOURCE_OPTIONS} selectedId={sourceId} />
        </View>
